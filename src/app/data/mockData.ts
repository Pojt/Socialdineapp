  ...
  h1: [
    {
      ...
      comment: 'Felt like being at my Italian friend\'s house. Maria is so warm and the pasta was perfect.',
      date: '2026-03-10'
    },
    {
      guestName: 'Michael',
      guestAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400',
      comment: 'Best meal I\'ve had in Brooklyn. The other guests were lovely too.',
      date: '2026-02-28'
    }
  ],
  h2: [
    {
      ...
      comment: 'Kenji explained every piece. Learned so much and ate even better.',
      date: '2026-03-15'
    }
  ],
  h3: [
    {
      ...
      comment: 'Like being invited to a family party. Carlos made everyone feel at home.',
      date: '2026-03-05'
    }
  ],
  h4: [
    {
      ...
      comment: 'Sophie\'s duck was incredible. Felt very Parisian even in New York.',
      date: '2026-02-20'
    }
  ],
  h5: [
    {
      ...
      comment: 'So much food! Everything was delicious and Layla made sure no one left hungry.',
      date: '2026-03-12'
    }
  ],
  h6: [
    {
      ...
      comment: 'The curries tasted like someone\'s grandmother made them. Absolutely authentic.',
      date: '2026-02-15'
    }
  ],
  h7: [
    {
      guestName: 'Chris',
      guestAvatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400',
      comment: 'Marcus knows his BBQ. The brisket was falling apart, so good.',
      date: '2026-03-01'
    }
  ],
  h8: [
    {
      ...
      comment: 'Intimate and beautifully executed. Alex really cares about every detail.',
      date: '2026-02-25'
    }
  ]
};
